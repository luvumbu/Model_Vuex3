...
<div class="index_class_1">
    <h1>
        <div>
            ...
            <p>
                Avec <b id="titre_page2">Bokonzi</b>, partagez et restez en contact avec votre entourage.
                <!-- <a id="listt_projet" href="blog.php">Voir tous les projet</a> -->
    ...
    <div class="index_class_3" id="form_1">
        <div>
            ...
            <br />
            <input type="button" value="Connexion" title="Connexion" id="btn_connexion" class="index_class_4 cursor_pointer" onclick="information_user_btn(this)">
            <!--
            <input type="button" value="Inscription" title="Inscription" id="btn_inscription" class="index_class_5 cursor_pointer" onclick="information_user_btn(this)">
            -->
